              ...
              SizedBox(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    SizedBox(width: 8.w),
                    _filterChip(context, 'accepted', 'sitter_app_status_accepted'.tr),
                    SizedBox(width: 8.w),
                    _filterChip(context, 'paid', 'sitter_app_status_paid'.tr),
                    SizedBox(width: 8.w),
                    _filterChip(context, 'cancelled', 'sitter_app_status_cancelled'.tr),
                  ],
                ),
              ),
